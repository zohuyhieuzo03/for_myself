...
export class ResourcesService {
     ...
     * @throws ApiError
     */
    public static searchAllSubjects(data: ResourcesSearchAllSubjectsData = {}): CancelablePromise<ResourcesSearchAllSubjectsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/resources/subjects/search',
            query: {
                skip: data.skip,
                limit: data.limit,
                search: data.search
...
export class RoadmapService {
     ...
     * @throws ApiError
     */
    public static searchAllMilestones(data: RoadmapSearchAllMilestonesData = {}): CancelablePromise<RoadmapSearchAllMilestonesResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/roadmap/milestones/search',
            query: {
                skip: data.skip,
                limit: data.limit,
                search: data.search
...
export class TodosService {
     ...
     * @throws ApiError
     */
    public static readTodoSubject(data: TodosReadTodoSubjectData): CancelablePromise<TodosReadTodoSubjectResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/todos/{id}/subject',
            path: {
                id: data.id
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static readTodosBySubject(data: TodosReadTodosBySubjectData): CancelablePromise<TodosReadTodosBySubjectResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/todos/by-subject/{subject_id}',
            path: {
                subject_id: data.subjectId
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static readCompletedDailyTodos(data: TodosReadCompletedDailyTodosData): CancelablePromise<TodosReadCompletedDailyTodosResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/todos/daily/{date}/completed',
            path: {
                date: data.date
            },
            errors: {
