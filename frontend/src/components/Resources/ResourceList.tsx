...
import { ResourcePublic, ResourceCreate, ResourceUpdate, ResourceSubjectCreate, ResourceSubjectUpdate } from "@/client";
...
export function ResourceList({ milestoneId }: ResourceListProps) {
  ...
  const handleSubjectSubmit = (data: ResourceSubjectCreate | ResourceSubjectUpdate) => {
    if (editingSubject) {
