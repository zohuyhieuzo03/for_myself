...
from app.models import Item, ItemCreate, User, UserCreate, UserUpdate, Todo, TodoCreate, TodoUpdate
...
def get_todos(*, session: Session, skip: int = 0, limit: int = 100) -> tuple[list[Todo], int]:
